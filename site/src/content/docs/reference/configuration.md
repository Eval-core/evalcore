...
| `datasets` | list of [dataset](#datasets) | yes | JSONL files of cases, merged in list order. |
...
| Field | Type | Required | Description |
|---|---|---|---|
| `file` | path | yes | JSONL file of cases, resolved relative to the config file's directory. |
