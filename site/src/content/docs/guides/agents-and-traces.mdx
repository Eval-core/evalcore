...
description: Evaluate what the agent did. Export OTel/OpenInference traces, grade the trajectory and the final answer, and read token, cost, and latency from the spans.
---

import CastFrame from '../../../components/CastFrame.astro';
...
<CastFrame
	cast="agent-trace"
	title="evalcore run examples/agent-trace/evals.yaml"
	...
	caption="Grade the answer and the path from one recorded trace, offline and deterministic."
/>
