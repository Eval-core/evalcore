---
title: HTML reports
description: "The --html flag and the Action's html-artifact input: what's in the self-contained report, why it uploads on failure, and its file:// friendliness."
---

import ReportEmbed from '../../../components/ReportEmbed.astro';
...
This is what comes out: a real report from the shipped quickstart suite,
embedded as-is:
